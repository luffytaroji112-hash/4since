...
const { handleConfirmClose, handleCopyButton, handleCloseButton } = require('../../utils/purchase/purchasethread');
const {
    handlesecureconfig,
    handlecosmetics,
    handleprofilesplit,
...
module.exports = async (client, interaction) => {
  ...
  try {
    ...
    if (action === "purchaseclose"){
      ...
      console.log(`Handling purchase copy.`)
      await handleCopyButton(interaction, interaction.customId.split("|")[1])
    } else if (action === "confirmclose"){
      await handleConfirmClose(interaction, interaction.customId.split("|")[1])
    }
