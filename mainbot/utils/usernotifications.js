...
async function sendpermissionsembed(client, owner, slave) {
  ...
  if (users.length === 0) {
    ...
    if (!currentUser) {
      ...
      embed.fields.push(
        { name: "Edit Autosecure", value: currentUser.editautosecure == 1 ? "✅" : "❌", inline: true },
        { name: "Edit Bot", value: currentUser.editbot == 1 ? "✅" : "❌", inline: true },
        { name: "Edit Claiming", value: currentUser.editclaiming == 1 ? "✅" : "❌", inline: true },
        { name: "Edit Embeds", value: currentUser.editembeds == 1 ? "✅" : "❌", inline: true },
